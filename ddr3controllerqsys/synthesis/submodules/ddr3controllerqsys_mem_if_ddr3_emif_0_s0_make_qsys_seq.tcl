...
lappend arg_list "--component-param=SEQ_ROM=ddr3controllerqsys_mem_if_ddr3_emif_0_s0_sequencer_mem.hex"
lappend arg_list "--component-param=RAM_BLOCK_TYPE=AUTO"
lappend arg_list "--component-param=AC_ROM_INIT_FILE_NAME=ddr3controllerqsys_mem_if_ddr3_emif_0_s0_AC_ROM.hex"
lappend arg_list "--component-param=INST_ROM_INIT_FILE_NAME=ddr3controllerqsys_mem_if_ddr3_emif_0_s0_inst_ROM.hex"
...
lappend arg_list "--component-param=SEQUENCER_MEM_SIZE=18432"
...
lappend arg_list "--output-name=ddr3controllerqsys_mem_if_ddr3_emif_0_s0"
lappend arg_list "--system-info=DEVICE_FAMILY=CYCLONEV"
lappend arg_list "--report-file=sopcinfo:ddr3controllerqsys_mem_if_ddr3_emif_0_s0.sopcinfo"
lappend arg_list "--report-file=txt:ddr3controllerqsys_mem_if_ddr3_emif_0_s0_seq_ipd_report.txt"
lappend arg_list "--file-set=QUARTUS_SYNTH"
catch { eval [concat [list exec "/home/abendezu/intelFPGA/23.1std/quartus/sopc_builder/bin/ip-generate" --component-name=qsys_sequencer_110] $arg_list] } temp
puts $temp
